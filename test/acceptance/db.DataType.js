  ...
  describeRemoteDB('FIXED', function () {
    describeRemoteDB('FIXED8', function () {
      ...
      it('should insert and return valid FIXED8 decimals', function (done) {
        ...
        var expected = [{A: null}, {A: '-1289128378.00000'}, {A: '-10000.12346'}, {A: '0.00000'}, {A: '1234.56789'}, {A: '9999.99200'},
          {A: '123456.00000'}, {A: '9999999999.99999'}];
    ...
    describeRemoteDB('FIXED12', function () {
      ...
      it('should insert and return valid FIXED12 decimals', function (done) {
        ...
        var expected = [{A: null}, {A: '-128127498912.00000'}, {A: '-7289481923.56125'}, {A: '0.00000'}, {A: '61274182.56789'},
          {A: '9007199254740991.00000'}, {A: '999999999999999999.99200'}, {A: '999999999999999999.99999'}];
    ...
    describeRemoteDB('FIXED16', function () {
      ...
      it('should insert and return valid FIXED16 decimals', function (done) {
        ...
        var expected = [{A: null}, {A: '-964060612622724383174786442765.46591'}, {A: '-257283749723.00000'}, {A: '-123456.90300'}, {A: '0.00000'},
          {A: '18724.23000'}, {A: '8312612546512631264781627841.78195'}, {A: '682104294101148412963771036529.00000'},
          {A: '999999999999999999999999999999.99200'}, {A: '999999999999999999999999999999.99999'}];
